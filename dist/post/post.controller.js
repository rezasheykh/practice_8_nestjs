...
__decorate([
    (0, common_1.Get)(),
    openapi.ApiResponse({ status: 200, type: [require("./entities/post.entity").PostEntity] }),
...
__decorate([
    ...
    openapi.ApiResponse({ status: 201, type: require("./entities/post.entity").PostEntity }),

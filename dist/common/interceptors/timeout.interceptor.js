...
let TimeoutInterceptor = class TimeoutInterceptor {
    ...
    intercept(context, next) {
        ...
        console.log('Timeout value: ', typeof this.configService.get('TIMEOUT'));
        return next.handle().pipe((0, rxjs_1.tap)((res) => {
            console.log(this.configService.get('TIMEOUT'));
        }), (0, rxjs_1.timeout)(this.configService.get('TIMEOUT')), (0, rxjs_1.catchError)((err) => {
